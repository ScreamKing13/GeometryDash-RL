...
class Estimator:
    ...
    def _build_model(self):
        ...
        self.fc2_o  = self.fc2_l(self.fc1_o)
        ...
        self.predictions = self.predictions_l(self.fc2_o)
    ...
    def get_feature_vector(self, sess, s):
        feature_vec = sess.run(self.fc2_o, {self.X_pl: np.expand_dims(s, 0)})
...
def deep_q_learning(sess,
    ...
    for i_episode in range(num_episodes):
        ...
        for t in count(start=1):
            ...
            # else:
            samples_rlt, ixs = replay_memory.sample_like(feature_vec, batch_size, sess, alpha=0.4)
            ...
            batch_loss, _ = q_estimator.update(sess, states_batch, action_batch, td_targets, 0.00025)
            loss += batch_loss
